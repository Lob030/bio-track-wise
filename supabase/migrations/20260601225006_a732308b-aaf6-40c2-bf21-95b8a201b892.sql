CREATE OR REPLACE FUNCTION public.consume_ai_prompt()
RETURNS void
LANGUAGE plpgsql
SECURITY DEFINER
...
GRANT EXECUTE ON FUNCTION public.consume_ai_prompt() TO authenticated;
REVOKE EXECUTE ON FUNCTION public.consume_ai_prompt() FROM anon;