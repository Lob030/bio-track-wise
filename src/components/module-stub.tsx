    ...
    <div className="p-6 max-w-6xl mx-auto space-y-4">
      ...
      <Card className="p-10 text-center border-dashed border-border bg-card/40">
        ...
        <p className="text-sm text-muted-foreground max-w-md mx-auto">
          La estructura base, el esquema de base de datos y las reglas de acceso por plan ya están
          listas para este módulo. La interfaz completa se habilita en la siguiente iteración.
        </p>
        {children}
      </Card>
    </div>
