  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <Select
          value={currentTheme}
          onValueChange={(val) => setTheme(val as ThemeId)}
          disabled={isLoading}
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-6">
        {allThemes.map((theme) => (
          ...
          >
            <Card
              className={`p-4 cursor-pointer hover:ring-2 hover:ring-emerald-glow/40 ${
            ...
            >
              <div className="flex items-start justify-between mb-2">
                ...
                {currentTheme === theme.id && (
                  <Badge
                    variant="default"
                    className="ml-2 bg-emerald-glow text-slate-950 font-medium"
                  >
                    Activo
                  </Badge>
                )}
