...
export function RodentSizeMatrix({ rules }: { rules: RodentRule[] }) {
  if (!rules?.length)
    return <p className="text-xs text-muted-foreground italic">Sin matriz definida.</p>;
  return (
