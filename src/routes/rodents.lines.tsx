...
export const Route = createFileRoute("/rodents/lines")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: 'Administra las líneas genéticas de roedores de tu bioterio.' },
      { property: "og:title", content: 'Líneas genéticas de roedores — BioTrack' },
      { property: "og:description", content: 'Administra las líneas genéticas de roedores de tu bioterio.' },
