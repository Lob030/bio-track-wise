...
export const Route = createFileRoute("/insects/tree")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: 'Explora la genealogía y descendencia de tus insectos en BioTrack.' },
      { property: "og:title", content: 'Árbol genealógico de insectos — BioTrack' },
      { property: "og:description", content: 'Explora la genealogía y descendencia de tus insectos en BioTrack.' },
